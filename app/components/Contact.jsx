  ...
  return (
    ...
    <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        <div className='grid grid-cols-auto gap-6 mt-10 mb-8 font-Ovo'>
            <input className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 bg-white rounded-md' type="text" placeholder='Enter your name' required name='name' />
            <input className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 bg-white rounded-md' type="email" placeholder='Enter your email' required name='email' />
        </div>
            <textarea className='w-full p-3  resize-none outline-none border-[0.5px] border-gray-400 bg-white rounded-md' rows="6" placeholder='Enter your Message'required name='message'
           ></textarea>
